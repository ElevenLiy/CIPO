#!/bin/bash
#SBATCH --job-name=traject_gipo_llama8b_2gpu
...
#SBATCH --output=logs/traject_gipo_llama8b_2gpu_%j.out
...
echo "============================================================"
echo "Traject-bench — GIPO 2-GPU — LLaMA 3.1-8B"
echo "============================================================"
...
echo "============================================================"
echo "Traject-bench — LLaMA 3.1-8B 2-GPU completed at $(date)"
echo "============================================================"
