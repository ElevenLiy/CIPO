#!/bin/bash
#SBATCH --job-name=toucan_gipo_qwen7b_2gpu
...
#SBATCH --output=logs/toucan_gipo_qwen7b_2gpu_%j.out
...
echo "============================================================"
echo "Toucan — GIPO 2-GPU — Qwen2.5-7B"
echo "============================================================"
...
echo "============================================================"
echo "Toucan — Qwen2.5-7B 2-GPU completed at $(date)"
echo "============================================================"
